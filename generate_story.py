...
if not(os.path.exists(collection_directory+"/ontopic_timemap.txt")):
    ...
    logger.info("Using cached version of on-topic: "+collection_directory+"/ontopic_timemap.txt")
...
if not(os.path.exists(collection_directory+"/timemap_english.txt")):
    ...
    logger.info("Using cached version of english: "+collection_directory+"/timemap_english.txt")
...
logger.info("writing stories out to {}".format(output_file))
